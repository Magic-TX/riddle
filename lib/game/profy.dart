...
import 'package:riddle/data/word3.dart';
import 'package:riddle/screens/over.dart';
import 'package:shared_preferences/shared_preferences.dart';

class Profy extends StatefulWidget {
  final String image;

  const Profy({super.key, required this.image});

  @override
  State<Profy> createState() => _ProfyState();
}

class _ProfyState extends State<Profy> {
  int coins = 0;
  ...
  WordDescription3 currentWord = wordsList[0];
